...
<nav
  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div
      ...
      <!-- Logo -->
      <img
          src="../public/images/icons/gawrgura1.png"
          style="height: 50px"
          alt="TE Logo"
          loading="lazy" />
